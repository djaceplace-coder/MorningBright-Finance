-- RUN THIS SCRIPT IN YOUR SUPABASE SQL EDITOR TO FIX RLS, ADD SUPPORT TABLES AND HARDLOCK ADMIN
-- This resolves the infinite recursion that blocks data loading
...
-- 8. Tickets Table for User Support and Document Uploads
...
-- 9. HARDLOCK ADMIN ROLE
-- Force support@morningbrightfinance.com to be an admin
UPDATE public.users 
SET is_admin = true 
